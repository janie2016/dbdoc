...
public class Column {
	...
	{
		return "Column ("+_sqlName+", "+this._sqlTypeName+", "+this._sqlTypeOuter+", "+this._remarks+", "+this._defaultValue+", "+this._sqlType+", "+this._size+", "+this._decimalDigits+", "+this._isPk+", "+this._isFk+", "+this._isNullable+", "+this._isIndexed+", "+this._isUnique+")";
	}
}
